...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PlotTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
    
    if (cell == NULL) {
        cell = [[PlotTableViewCell alloc] init];
    }
    
    NSUInteger index = indexPath.row;
    
    NSDictionary *data = [self.tableData objectAtIndex:index];
